...
const Card = ({ readMessage, el, i , readUser}) => {
    console.log(el);
    return (
        <Link href={{pathname: '/', query: '${el.name}', addres: '${el.pubkey}'}}>

            <div className={Style.Card} onClick={()=>(readMessage(el.pubkey))}>
                <div className={Style.Card_box}>
                    <div className={Style.Card_box_left}>
                        <Image className={Style.Card_box_left_img}
                            src={images.accountName}
                            alt="username"
                            width={50}
                            height={50}
                            classNames={Style.Card_box_left_img}
                        />
                    </div>
